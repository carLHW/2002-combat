# UML Class Diagram (Implementation Focused)

- Purpose:
  - show the gameplay classes the team is mainly implementing
  - keep the shared structure visible, but not crowded with details
- Detail rule:
  - concrete gameplay classes are detailed
  - shared / already-set structure is mostly empty
- Scope:
